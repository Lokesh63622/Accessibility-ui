...
//     const moreData = await fetchAccessibilityReports(nextPage, PAGE_SIZE, filters.searchUrl);
...
//       setLoading(true);
//       const data = await fetchAccessibilityReports(0, PAGE_SIZE, filters.searchUrl);
//       setAllReports(data);
...
//   // Reload on search URL change
//   useEffect(() => {
//     async function reloadWithSearch() {
//       setLoading(true);
//       const data = await fetchAccessibilityReports(0, PAGE_SIZE, filters.searchUrl);
//       setAllReports(data);
//       setFilteredReports(applyFilters(data, filters));
